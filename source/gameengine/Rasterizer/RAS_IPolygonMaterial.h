...
public:
	...
	virtual void ActivateInstancing(RAS_Rasterizer *rasty, void *matrixoffset, void *matrixinvoffset, void *positionoffset, void *coloroffset, unsigned int stride) = 0;
